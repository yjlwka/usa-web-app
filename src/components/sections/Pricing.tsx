    ...
    <section id="pricing" className="py-5">
      <Container className="text-center">
        ...
        <Paragraph className="mt-4">
          Choisis l'abonnement adapté à ton ambition sportive.
        </Paragraph>
      </Container>
          ...
          {pricingPlans.map((plan, key) => (
            <div key={key} className="relative group h-full">
              ...
              p-8 flex flex-col h-full relative"
                ...
                text-white text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full bg-gradient-to-r from-blue-600 to-violet-600"
                    >
                      Best Value
                    </div>
                  )}
                  ...
                  <p className="text-4xl font-bold mt-4 text-heading-1">
                    {" "}
                    {plan.price}
                  </p>
